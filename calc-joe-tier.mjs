import { calculateTier, computeRollingAverages } from './shared/commission.ts';
...
console.log('Metrics:', last3ForJan);
...
console.log(`\nJanuary Tier: ${tierResult.tier} (${tierResult.rate * 100}%)`);
console.log(`Breakdown:`, tierResult.breakdown);
...
console.log('Metrics:', last3ForFeb);
...
console.log(`\nFebruary Tier: ${tierResultFeb.tier} (${tierResultFeb.rate * 100}%)`);
console.log(`Breakdown:`, tierResultFeb.breakdown);
